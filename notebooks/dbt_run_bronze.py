...
# This notebook runs dbt models for the Bronze layer

dbutils.widgets.text("catalog", "streaming_dev")
catalog = dbutils.widgets.get("catalog")

print(f"Starting dbt run for Bronze layer in catalog: {catalog}")
...
try:
    ...
    if result.returncode == 0:
        ...
        print("❌ Bronze layer build failed")
        dbutils.notebook.exit("Bronze build failed")
